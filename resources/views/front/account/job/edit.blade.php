                  ...
                  <div class="card border-0 shadow mb-4 ">
                    <div class="card-body card-form p-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <select class="form-select" name="experience" id="experience">
                                 <option {{ ($job->experience == 1  )  ? 'selected' : '' }} value="1">0-1 Year</option>
                                 <option {{ ($job->experience == 2  )  ? 'selected' : '' }} value="2">1-2 Year</option>
                                 <option {{ ($job->experience == 3  )  ? 'selected' : '' }} value="3">2-3 Year</option>
                                 <option {{ ($job->experience == 4  )  ? 'selected' : '' }} value="4">3-4 Year</option>
                                 <option {{ ($job->experience == 5  )  ? 'selected' : '' }} value="5">4-5 Year</option>
                                 <option {{ ($job->experience == 6  )  ? 'selected' : '' }} value="6">5-6 Year</option>
                                 <option {{ ($job->experience == 7  )  ? 'selected' : '' }} value="7">6-7 Year</option>
                                 <option {{ ($job->experience == 8  )  ? 'selected' : '' }} value="8">7-8 Year</option>
                                 <option {{ ($job->experience == 9  )  ? 'selected' : '' }} value="9">8-9 Year</option>
                                 <option {{ ($job->experience == 10 )  ? 'selected' : '' }} value="10">9-10 Year</option>
                                 <option {{ ($job->experience == 11 )  ? 'selected' : '' }} value="10_plus">10+ Year</option>
                                </select>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input value="{{ $job->company_location }}" type="text" placeholder="Website" id="website" name="website" class="form-control">
                        </div>
                    </div> 
