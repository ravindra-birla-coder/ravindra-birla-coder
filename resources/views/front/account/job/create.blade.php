    ...
    <div class="container py-5">
        ...
        <div class="row">
           <div class="col-lg-3">
            ...
            <form action="" method="POST"  id="saveJobForm" name="saveJobForm">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <select class="form-select" name="experience" id="experience">
                                 ...
                                 <option value="7">6-7 Year</option>
                                 <option value="8">7-8 Year</option>
                                 <option value="9">8-9 Year</option>
                                 <option value="10">9-10 Year</option>
...
<script>
   ...
   $.ajax({
      ...
      type: 'POST',
      data: $('#saveJobForm').serializeArray(),
      datatype: 'json',
